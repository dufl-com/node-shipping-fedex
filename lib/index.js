...
function FedEx(args) {
    ...
    function buildShipment(data) {
        ...
        if((moment(data.ship_timestamp).isoWeekday()!=6)||(shipment.ServiceType!="PRIORITY_OVERNIGHT" && shipment.ServiceType!="FEDEX_2_DAY")){
            delete shipment["SpecialServicesRequested"];
        }
    ...
    $scope.handleRateResponse = function(json, callback) {
        ...
        return callback(null, json.RateReply);
    };
    ...
    $scope.handleProcessShipmentResponse = function(json, callback) {
        if (json['v13:ProcessShipmentReply']) {
            if (json['v13:ProcessShipmentReply']['v13:HighestSeverity'] == "ERROR") {
                return callback(json['v13:ProcessShipmentReply']['v13:HighestSeverity'], null);
            }
        } else {
